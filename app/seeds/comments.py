...
def seed_comments():
    ...
    comment5 = Comment(user_id=5, item_id='6467a03b03356945427f6068', text='This item has a great design.')
    ...
    comment9 = Comment(user_id=9, item_id='60b033cd0b408201818d663d', text='This item is totally cool.')
    ...
    comment18 = Comment(user_id=5, item_id='60b033cd0b408201818d663d', text='Not really sure I like this one.')
    ...
    comment22 = Comment(user_id=9, item_id='6467a03b03356945427f6068', text='Looks great, but not practical.')
