...
def seed_items():
    ...
    master_chief = Item(
        ...
        price_icon_link='https://image.fnbr.co/price/icon_vbucks.png',
        images={
            "icon":'https://image.fnbr.co/outfit/5fd2b936c0132843480146e8/icon.png',
            "featured": 'https://image.fnbr.co/outfit/5fd2b936c0132843480146e8/featured.png'
        },
