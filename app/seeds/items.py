...
def seed_items():
    elite_agent = Item(
        ...
        images={
            "image_icon":'https://image.fnbr.co/outfit/5ab16ae85f957f27504aa4df/icon.png',
            "image_gallery":'https://image.fnbr.co/outfit/5ab16ae85f957f27504aa4df/gallery.png',
        },
        rarity='epic',
        type='outfit',
        slug='elite-agent',
    ...
    mj_no_way_home = Item(
        ...
        images={
            "image_icon":'https://image.fnbr.co/outfit/61bb53b3bd358a192111d97c/icon.png',
            "image_featured":'https://image.fnbr.co/outfit/61bb53b3bd358a192111d97c/featured.png',
        },
        rarity='marvel',
        type='outfit',
        slug='mj-no-way-home',
    ...
    spider_man_2099 = Item(
        ...
        price_icon_link='https://image.fnbr.co/price/icon_vbucks.png',
        images={
            "image_icon":'https://image.fnbr.co/outfit/6467a03b03356945427f6068/icon.png',
            "image_featured":'https://image.fnbr.co/outfit/6467a03b03356945427f6068/featured.png',
        },
        rarity='marvel',
        type='outfit',
    ...
    teef = Item(
        ...
        price_icon_link='https://image.fnbr.co/price/icon_vbucks.png',
        images={
            "image_icon":'https://image.fnbr.co/outfit/5daedbcebffa742e002c321c/icon.png',
            "image_gallery":'https://image.fnbr.co/outfit/5daedbcebffa742e002c321c/gallery.png',
            "image_featured":'https://image.fnbr.co/outfit/5daedbcebffa742e002c321c/featured.png',
        },
        rarity='epic',
        type='outfit',
        slug='teef',
