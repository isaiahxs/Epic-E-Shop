...
def upgrade():
    ...
    sa.Column('price_icon', sa.String(length=1000), nullable=False),
    sa.Column('price_icon_link', sa.String(length=1000), nullable=False),
    ...
    sa.Column('readable_type', sa.String(length=1000), nullable=False),
    sa.Column('description', sa.String(length=1000), nullable=False),
    sa.Column('bundle_set', sa.String(length=1000), nullable=True),
    sa.Column('banner_text', sa.String(length=1000), nullable=True),
